(function () {
   ...
   function w(a) {
      if ("undefined" !== typeof JSON && t(JSON.stringify))a = JSON.stringify(a); else {
         var b = [];
         oa(new na, a, b);
         a = b.join("")
      }
   ...
   function K(a, b) {
      for (var c = b instanceof J ? b : new J(b), d = a, e; (e = E(c)) !== k;)d = new Pa(e, d, wa(d.z.children, e) || new Oa), c = Ma(c);
      return d
   }
   ...
   function Za(a) {
      ...
      var b = a.Tb.pop(), c;
      c = a.md ? a.md(b.key, b.value) : {key: b.key, value: b.value};
   ...
   s.remove = function (a, b) {
      var c, d;
      c = this;
      if (0 > b(a, c.key))!c.left.f() && (!c.left.N() && !c.left.left.N()) && (c = fb(c)), c = c.copy(k, k, k, c.left.remove(a, b), k); else {
         c.left.N() && (c = gb(c));
   ...
   sb.prototype.update = function (a, b) {
      ...
      if (u(a))for (; e < b;)c[d++] = a.charCodeAt(e++), 64 == d && (tb(this, c), d = 0); else for (; e < b;)c[d++] = a[e++], 64 == d && (tb(this, c), d = 0);
      this.ob = d;
      this.Vc += b
   };
   ...
   s.Ub = o(0);
   s.V = function (a) {
      return a && this.j() !== k ? {".value": this.k(), ".priority": this.j()} : this.k()
   };
   s.hash = function () {
      var a = "";
   ...
   s.H = function (a, b) {
      ...
      c !== k && (d = d.remove(a), e = e.remove({name: a, ia: c.j()}));
      b && b.f() && (b = k);
      b !== k && (d = d.oa(a, b), e = e.oa({name: a, ia: b.j()}, b));
      return new lc(d, e, this.j())
   };
   s.ea = function (a, b) {
      var c = Xa(this.ua, {name: a, ia: b.j()});
      return c ? c.name : k
   };
   s.w = function (a) {
   ...
   function Q(a, b) {
      ...
      bc(a, function (b, c) {
         if ("string" !== typeof c || "." !== c.substring(0, 1)) {
            var d = Q(a[c]);
            d.f() || (h = h || d.j() !== k, e.push({name: c, ia: d.j()}), f[c] = d)
         }
      });
      var i = nc(e, f, l);
      if (h) {
      ...
      function c() {
         if (!d.Ja) {
            d.ka = new Kc(function (a, b, c, e, f) {
               ...
               if (d.ka)if (d.ba && (clearTimeout(d.ba), d.ba = k), d.kb = j, "start" == a)d.id = b, d.jd = c; else if ("close" === a)if (b) {
                  d.ka.ic = l;
                  var h = d.fd;
                  h.tc = b;
                  h.Ka = function () {
               ...
               } else d.Ea(); else g(Error("Unrecognized command received: " + a))
            }, function (a, b) {
               xc(d.$, "bytes_received", w(arguments).length);
               var c = d.fd;
   ...
   Hc.prototype.send = function (a) {
      ...
      for (var a = ta(a), a = Mb(a, j), a = ac(a, 1840), b = 0; b < a.length; b++) {
         var c = this.ka;
         c.Cb.push({Qd: this.Zc, Vd: a.length, ad: a[b]});
         c.pc && Mc(c);
         this.Zc++
      }
   };
   ...
   S.prototype.open = function (a, b) {
      ...
      this.W.onmessage = function (a) {
         if (c.W !==
            k)if (a = a.data, xc(c.$, "bytes_received", a.length), Qc(c), c.frames !== k)Rc(c, a); else {
            a:{
   ...
   function Wc(a, b) {
      return function (c) {
         ...
         } else b === a.A ? (d = $b("t", c), c = $b("d", c), "c" == d ? "t"in c && (c = c.t, "a" === c ? (a.A.start(), a.e("sending client ack on secondary"), a.A.send({t: "c", d: {t: "a",
            d: {}}}), a.e("Ending transmission on primary"), a.K.send({t: "c", d: {t: "n", d: {}}}), a.Jb = a.A, Yc(a)) : "r" === c && (a.e("Got a reset on secondary, closing it"), a.A.close(), (a.Jb === a.A || a.Hb === a.A) && a.close())) : "d" == d ? a.$b.push(c) : g(Error("Unknown protocol layer: " + d))) : a.e("message on old connection")
      }
   }
   ...
   function jd(a, b, c, d) {
      a.P ? kd(a, "o", b, c, d) : a.wb.push({Mc: b, action: "o", data: c, C: d})
   }

   s.Hc = function (a, b) {
      this.P ? kd(this, "oc", a, k, b) : this.wb.push({Mc: a, action: "oc", data: k, C: b})
   };
   ...
   s.gd = function () {
      ...
      if (this.Na)this.gb ? this.rb && (3E4 < (new Date).getTime() - this.rb && (this.qa = 1E3), this.rb = k) : (this.e("Window isn't visible.  Delaying reconnect."), this.qa = this.Rb, this.Fc = (new Date).getTime()), a = Math.max(0, this.qa - ((new Date).getTime() - this.Fc)), a *= Math.random(), this.e("Trying to reconnect in " +
         a + "ms"), dd(this, a), this.qa = Math.min(this.Rb, 1.3 * this.qa); else for (var c in this.Gb)delete this.Gb[c];
      this.Wb(l)
   };
   s.Ia = function () {
      this.Na = l;
   ...
   function Cd(a, b) {
      for (var c = [], d = 0; d < b.length; d++) {
         ...
         for (f = 0; f < a.na.length; f++) {
            var i = a.na[f];
            b[d].type === i.type && c.push({X: i.T ? v(i.X, i.T) : i.X, pd: h, Db: e.Db})
         }
      }
      xd(a.xc, c)
   }
   ...
   function Jd(a, b, c, d, e) {
      ...
      P = d.Ua();
      for (G = Za(P); I !== k || G !== k;) {
         c = I === k ? 1 : G === k ? -1 : I.key === G.key ? 0 : ic({name: I.key, ia: I.value.j()}, {name: G.key, ia: G.value.j()});
         if (0 > c)f = wa(q, I.key), t(f) ? (n.push({zc: I, Tc: i[f]}), i[f] = k) : (r[I.key] = m.length, m.push(I)), f = j, I = Za(x); else {
            if (0 < c)f = wa(r, G.key), t(f) ? (n.push({zc: m[f], Tc: G}), m[f] = k) : (q[G.key] = i.length, i.push(G)), f = j; else {
               c = b.F(G.key);
               if (c = Id(a, c, I.value, G.value))p.push(G), f = j;
               I.value.j() !==
               G.value.j() && (n.push({zc: I, Tc: G}), f = j);
               I = Za(x)
            }
            G = Za(P)
         }
   ...
   Qd.prototype.Mb = function (a, b, c, d, e) {
      ...
      if (i.contains(m))a = i.get(m), Ad(a, b, c, d, e); else {
         ...
         if (Md(i) || Rd(h))i.add(m, n), i.S || (i.S = n.I.path); else {
            var p, q;
   ...
   function Xd(a, b, c, d, e) {
      ...
      cc(b, function (b, n) {
         var p = new J(n);
         3 === b || 1 === b ? h = h.H(n, d.Q(p)) : (2 === b && i.push({path: f.F(n), pa: N}), i = i.concat(Yd(a, d.Q(p), K(c, p), e)))
      });
      return[
         {path: f, pa: h}
      ].concat(i)
   ...
   function Zd(a, b, c, d) {
      ...
      h = K(a.la, b);
      f = h.k();
      f !== k ? Ld(f) ? e.push({path: b, pa: c}) : e = e.concat(Xd(a, f, h, c, d)) : e = e.concat(Yd(a, c, h, d));
      return e
   }
   ...
   s.bb = function (a, b, c, d) {
      this.e("set", {path: a.toString(), value: b, ia: c});
   ...
   s.Pc = function (a, b, c) {
      this.e("setPriority", {path: a.toString(), ia: b});
   ...
   function fe(a, b) {
      ...
      if (0 !== c.length) {
         for (var e = T(a.g.ma, d), f = e, h = [], i = 0; i < c.length; i++) {
            ...
            if (5 === c[i].status)n = j, p = c[i].oc; else if (1 === c[i].status)if (25 <= c[i].nd)n = j, p = "maxretry"; else {
   ...
   function pe(a) {
      var b = a.k();
      if (b !== k) {
         for (var c = [], d = -1, e = 0; e < b.length; e++)4 !== b[e].status && (2 === b[e].status ? (y(d === e - 1, "All SENT items should be at beginning of queue."), d = e, b[e].status = 4, b[e].oc = "set") : (y(1 === b[e].status), b[e].nc(), b[e].C && c.push(v(b[e].C, k, Error("set"), l, k))));
   ...
   $.prototype.update = function (a, b) {
      ...
      for (f in a)e = l;
      if (e)L("onDisconnect().update() called with empty data.  Don't do anything."), X(b, "ok"); else {
         e = c.u;
         f = d.toString();
         var h = function (e, f) {
            if ("ok" === e)for (var h in a) {
               var p = Q(a[h]);
               od(c.R, d.F(h), p)
            }
            X(b, e, f)
         };
         e.P ? kd(e, "om", f, a, h) : e.wb.push({Mc: f, action: "om",
            data: a, C: h})
      }
   };
   ...
   function H() {
      ...
      if (arguments[0]instanceof be)c = arguments[0], a = arguments[1]; else {
         ...
         b = new J(f);
         e = b.toString();
         if (!(d = !u(a.host)))if (!(d = 0 === a.host.length))if (!(d = !za(a.Sb)))if (d =
   ...
   H.prototype.transaction = function (a, b, c) {
      ...
      var i =
         new H(e, f);
      i.Xa("value", d);
      var h = {path: f, update: a, C: b, status: k, hd: Nb(), qc: h, nd: 0, nc: function () {
         i.ub("value", d)
      }, oc: k}, m = h.update(T(e.fb, f).V());
      if (t(m)) {
